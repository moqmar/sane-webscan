...
// webFaviconIco reads file data from disk. It returns an error on failure.
func webFaviconIco() (*asset, error) {
	path := "/home/momar/Projekte/go/src/teahub.io/momar/sane-webscan/web/favicon.ico"
...
func webIndexHtml() (*asset, error) {
	path := "/home/momar/Projekte/go/src/teahub.io/momar/sane-webscan/web/index.html"
	name := "web/index.html"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
...
// webScriptJs reads file data from disk. It returns an error on failure.
func webScriptJs() (*asset, error) {
	path := "/home/momar/Projekte/go/src/teahub.io/momar/sane-webscan/web/script.js"
	name := "web/script.js"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
...
// webStyleCss reads file data from disk. It returns an error on failure.
func webStyleCss() (*asset, error) {
	path := "/home/momar/Projekte/go/src/teahub.io/momar/sane-webscan/web/style.css"
	name := "web/style.css"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
